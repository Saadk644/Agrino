		...
		<>
			...
			>
				<center>
					...
					<h3 style={{color:'green'}}>Please Specify Details</h3>
							...
							<form onSubmit={handleSubmit} style={{padding:'0 20px'}}>
								<div class="form-group row">
									<div for="" className="col-md-3 fs-5">
										<label style={{color:'green'}}>Area Unit</label>
									</div>
								...
								<div class="form-group row mt-4">
									<div for="" className="col-md-3 fs-5">
										<label style={{color:'green'}}>Width</label>
									</div>
									<div className="col-md-7">
								...
								<div class="form-group row mt-4">
									<div for="" className="col-md-3 fs-5">
										<label style={{color:'green'}}>Height</label>
									</div>
									<div className="col-md-7">
